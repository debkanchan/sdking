...
export async function get(queryParams?: {
  ...
  if (queryParams) {
    ...
    if (queryParams.username !== undefined) searchParams.append('username', String(queryParams.username));
    if (queryParams.password !== undefined) searchParams.append('password', String(queryParams.password));
