...
program
  ...
  .requiredOption('-o, --output <directory>', 'Output directory for the generated SDK')
  .option('-p, --import-prefix', 'Import prefix for generated files (.js, .ts, or false for no prefix). Defaults to ".js"', '.js')
  ...
  .action(async (options) => {
    try {
      ...
      if (importPrefix && !['.js', '.ts', false].includes(importPrefix)) {
        throw new Error('Invalid import prefix. Must be ".js", ".ts", or false.');
      }
