...
import { extractRoutes, generateRouteFiles, generateAliasFile } from './route-generator.js';
 ...
 */
export async function generateSDK(options: GeneratorOptions, writeFile: FileWriter, mkdir: DirMaker): Promise<void> {
 ...
 */
function generateReadme(spec: OpenAPISpec, outputDir: string, writeFile: FileWriter): void {
